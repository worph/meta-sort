...
/**
 * Get value from object using path-style key
 * First checks for flat key (e.g., "fileinfo/duration"), then tries nested traversal
 */
 ...
 * Handles both flat keys (e.g., "stream/0") and nested objects
 */
